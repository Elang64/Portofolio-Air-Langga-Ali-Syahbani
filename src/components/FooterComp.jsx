            ...
            <div className="max-w-6xl mx-auto px-6 relative z-10">
                <div className="flex flex-col items-center justify-center text-center">
                    ...
                    <p className="text-gray-400 text-sm max-w-md leading-relaxed">
                        Butuh bantuan, memiliki pertanyaan, atau ingin berkolaborasi? Jangan ragu untuk menghubungi saya melalui platform berikut.
                    </p>

                    {/* PERBAIKAN: Struktur dibalik (<a> membungkus <button>) agar styling CSS kustom Anda tetap aktif */}
